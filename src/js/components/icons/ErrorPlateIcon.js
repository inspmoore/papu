...
export default function EmptyPlateIcon({ color = '#09ace8' }) {
  return (
    <svg
    ...
    >
      <path
        ...
        transform="translate(245.515 86) rotate(180)"
      />
      <path
        fill={color}
        ...
        transform="translate(-308.916 0.362)"
      />
      <g
        fill="#fff"
        stroke={color}
      ...
      <path
        ...
        transform="translate(28.434 14)"
      />
      <g transform="translate(77.622 4.613) rotate(45)">
